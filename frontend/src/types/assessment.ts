...
export type AssessmentSnapshot = { sessionId: string; projectId?: string; status: AssessmentStatus; completion: AssessmentCompletion; modelVersionId: string; currentQuestion?: AssessmentQuestion; competencies: CompetencyProgress[]; turns: AssessmentTurn[]; evidenceGroups?: EvidenceGroup[]; agentStatus?: AgentStatus; retryable: boolean; error?: string }
