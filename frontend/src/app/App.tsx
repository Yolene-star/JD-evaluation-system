...
export default function App() {
  ...
  const selectProject = (id: string) => { setActiveId(id); setReply(''); setPendingOperation(undefined); setAppError(''); setShowAssessment(false); setShowReport(false); setAssessmentSnapshot(undefined); setReport(undefined); setReportSessionId(undefined) }
  const loadReport = async () => {
    ...
    try {
      ...
      if (rows[0]) { setReport(rows[0]); return }
